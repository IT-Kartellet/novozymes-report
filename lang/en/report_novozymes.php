...
$string['pluginname'] = 'Novozymes course participation';

$string['title'] = 'Novozymes course participation';
$string['heading'] = 'Novozymes report';

$string['id'] = 'Id';
$string['count'] = 'User count';
$string['dc_count'] = 'Datecourse count';
